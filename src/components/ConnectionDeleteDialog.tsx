...
export function ConnectionDeleteDialog({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      notifyError(`Could not delete connection: ${String(e)}`);
      setBusy(false);
    }
  };
    ...
    >
      ...
      >
        ...
        <div className="px-4 py-4 text-[12px] leading-relaxed text-zinc-300">
          <p>
            This removes the saved connection profile. Your database and its data
            are <span className="font-semibold text-zinc-100">not</span> affected.
          </p>
        </div>
        ...
        <div className="flex justify-end gap-2 border-t border-zinc-800 px-4 py-3">
          ...
          <button
            data-el="connection-delete-confirm-btn"
