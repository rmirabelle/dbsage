...
export const HELP_SCREENSHOTS = {
  ...
  "db-menu": { physicalWidth: 460, physicalHeight: 441, framing: "database context menu" },
  "db-compare_schema_config": { physicalWidth: 930, physicalHeight: 780, framing: "database compare dialog" },
  "table-compare_schema_config": { physicalWidth: 930, physicalHeight: 430, framing: "table compare dialog" },
  "db-diff": { physicalWidth: 910, physicalHeight: 728, framing: "annotated database diff" },
  "table-sync": { physicalWidth: 830, physicalHeight: 659, framing: "synchronize schema dialog" },
  ...
  "connection-admin-service": { physicalWidth: 883, physicalHeight: 423, framing: "service tab" },
  "connection-admin-logs": { physicalWidth: 940, physicalHeight: 590, framing: "logs tab" },
  "connection-reorder": { physicalWidth: 538, physicalHeight: 481, framing: "annotated connection drag" },
  "connection-db_expanded": { physicalWidth: 380, physicalHeight: 444, framing: "annotated expanded database" },
  "db-search": { physicalWidth: 775, physicalHeight: 429, framing: "annotated database search" },
  "db-multiselect": { physicalWidth: 1108, physicalHeight: 496, framing: "multi-table context menu" },
  "table-columns_filter": { physicalWidth: 726, physicalHeight: 606, framing: "column visibility menu" },
  "table-copy_rows_and_columns": { physicalWidth: 801, physicalHeight: 549, framing: "cell selection copy menu" },
  "table-column_menu": { physicalWidth: 675, physicalHeight: 546, framing: "column sort and filter menu" },
  "table-filter-auto_suggest": { physicalWidth: 659, physicalHeight: 544, framing: "Equals filter with value suggestions" },
  "table-views": { physicalWidth: 960, physicalHeight: 581, framing: "saved Views menu" },
  "table-select_row": { physicalWidth: 928, physicalHeight: 399, framing: "annotated row selection" },
  "table-select cell": { physicalWidth: 691, physicalHeight: 306, framing: "annotated cell selection" },
  "table-duplicate_row": { physicalWidth: 1158, physicalHeight: 366, framing: "annotated duplicated row" },
  "table-edit_cell": { physicalWidth: 670, physicalHeight: 416, framing: "annotated inline cell edit" },
  "table-import_json": { physicalWidth: 805, physicalHeight: 583, framing: "JSON import preview dialog" },
  "table-import_json_map": { physicalWidth: 805, physicalHeight: 750, framing: "JSON field mapping dialog" },
  "table-json": { physicalWidth: 1473, physicalHeight: 1318, framing: "annotated JSON tools workspace" },
  "table-new": { physicalWidth: 1550, physicalHeight: 1218, framing: "annotated new table designer" },
